...
from .views import followRequest, video_in_boundary, post_visualization, post_like, get_post_comment, post_comment
...
urlpatterns = [
    ...
    path('video/<str:videopk>/get_comment', get_post_comment, name="Get Video Comments"),
